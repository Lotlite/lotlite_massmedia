      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-2xl font-bold text-white">MarketPro</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/services/smm" className="text-gray-400 hover:text-white transition-colors">
                  Social Media Marketing
                </Link>
              </li>
              <li>
                <Link href="/services/paid-ads" className="text-gray-400 hover:text-white transition-colors">
                  Paid Advertising
                </Link>
              </li>
              <li>
