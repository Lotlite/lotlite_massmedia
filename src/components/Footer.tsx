        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-6 mt-6">
              ...
              <a href="https://wa.me/918805843309" target="_blank" rel="noopener noreferrer" className="bg-gray-800 p-2 rounded-full text-white hover:text-green-500 hover:bg-gray-700 transition-all">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
